...
///start update
...

    {
        ...
        $this->load->view('csv_update/royal_training');
...

    {
        ...
        $this->load->view('csv_update/csv_workframeworkout');
...

    {
        ...
        $this->load->view('csv_update/csv_retires');
...
WHERE
	...
	1 = 1 AND cs.id ={$idrow} OR  CONCAT(cs.lastname ,' ', cs.firstname) LIKE '%{$name}%'";
        ...
        if ($record) {
            ...
            } elseif ($this->input->get('frm') == 'workframeworkout') {



                $this->load->view('csv_update/csv_workframeworkout', $data);



            } elseif ($this->input->get('frm') == 'training') {



                $this->load->view('csv_update/training', $data);

            }elseif ($this->input->get('frm') == 'royal_training') {



                $this->load->view('csv_update/royal_training', $data);

            }elseif ($this->input->get('frm') == 'retires') {



                $this->load->view('csv_update/csv_retires', $data);
...
//                 = query("DELETE FROM `civilservant` WHERE `civilservant.id` = '{$id}' ");
    ...
    public function save_csv_frameworkout()
    ...
    ////end workframeworkout
    public function save_csv_training()
    ...
    ////end training in cambodia and another country
    ...
    ///// Function Royal training finish
