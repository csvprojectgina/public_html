...
$mpdf = new mPDF();
$title = 'ស្ថិតិមន្រ្តីរាជការ ទទួលបានច្បាប់ឈប់សម្រាក';
...
$body = '<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;font-family: khmermef1; width: 100%; text-align: center;">
           <thead>
            <tr style="background-color: lightgrey;">
                ...
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">កាលបរិច្ឆេទចាប់ផ្ដើម</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">កាលបរិច្ឆេទបញ្ចប់</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">មូលហេតុ</th>
    ...
    if ($getleader->num_rows() > 0) {
        ...
        foreach ($getleader->result() as $row) {
            $body .= '<tr>
                        ...
                        <td style="height: 20px;">' . $row->referencse_no . '</td>
