        ...
        <tbody>
            ...
            foreach ($list_array as $row) {
                ...
                <tr>
                    ...
                    <td><?php echo isset($arr_gd_office[$row['csv_general_dep']])?$arr_gd_office[$row['csv_general_dep']]:''?></td>
                    <td><?php echo isset($arr_dp_office[$row['csv_department']])?$arr_dp_office[$row['csv_department']]:'' ?></td>
                    <td><?php echo isset($arr_offices[$row['csv_office']])?$arr_offices[$row['csv_office']]:'' ?></td>
                </tr>
            ...
            preConfirm: function () {
                return new Promise(function (resolve) {
                    ...
                    $.ajax({
                        ...
                        type: "post",
                        dataType: "json",
                        data: {csv_list:list_csv,unit_id:<?php echo $get_unit_id ?>},
                        cache: false
                    }).done(function (data) {
                        if (data.status) {
                            swal({
