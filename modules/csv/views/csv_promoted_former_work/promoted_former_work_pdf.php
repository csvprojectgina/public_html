...
$mpdf = new mPDF();
$title = 'ស្ថិតិមន្រ្តីរាជការ តម្លើងឋានន្តរសក្កិតាម វេន/អតីតការងារ';
...
$body = '<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;font-family: khmermef1; width: 100%; text-align: center;">
           <thead>
            <tr style="background-color: lightgrey;">
                ...
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">ក្របខណ្ឌចាស់</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">ក្របខណ្ឌថ្មី</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">កាលបរិច្ឆេទតម្លើង</th>
    ...
    if ($getleader->num_rows() > 0) {
        ...
        foreach ($getleader->result() as $row) {
            $body .= '<tr>
                        ...
                        <td style="height: 20px;">' . $row->ex_salary . '</td>
                        <td style="height: 20px;">' . $row->salary_level . '</td>
