                        ...
                        <div class="modal-body">
                          <div class="bs-example">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="general_deps" id="inputEmail" placeholder="បញ្ជូលអគ្គនាយកដ្ឋាន" value="<?php echo @$row->general_deps_name; ?>">
                                    <input type="hidden" name="general_dep_id" value="<?php echo @$row->general_dep_id; ?>">
                                </div>
