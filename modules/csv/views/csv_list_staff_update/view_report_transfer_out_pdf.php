...
$mpdf = new mPDF();
$title = 'ស្ថិតិមន្រ្តីរាជការ​ ប្ដូរចេញ';
...
$strsql = "SELECT   cs.id,
                    ...
                    LEFT JOIN tbl_csvupdate as su ON su.csv_id=cs.id WHERE su.is_type = 'transfer_out'";
...
$body = '<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;font-family: khmermef1; width: 100%; text-align: center;">
           <thead>
            <tr style="background-color: lightgrey;">
                ...
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">ក្របខ័ណ្ឌថ្មី</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:14px ">កាលបរិច្ឆេទប្ដូរ</th>
    ...
    if ($getleader->num_rows() > 0) {
        ...
        foreach ($getleader->result() as $row) {
            $body .= '<tr>
                        ...
                        <td style="height: 20px;">' . $row->transfer_job_out . '</td>
