...
$mpdf = new mPDF();
$title = 'ស្ថិតិមន្រ្តីរាជការទទួលបានមេដាយនិងគ្រឿងឥស្សរិយយស';
...
$body = '<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;font-family: khmermef1; width: 100%; text-align: center;">
           <thead>
            <tr style="background-color: lightgrey;">
                ...
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px">ប្រភេទមេដាយ</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px ">ថ្នាក់នៃមេដាយ</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px ">កាលបរិច្ឆេទ</th>
    ...
    if ($getleader->num_rows() > 0) {
        ...
        foreach ($getleader->result() as $row) {
            $body .= '<tr>
                        ...
                        <td style="height: 30px;">' . $row->medal_type . '</td>
                        <td style="height: 30px;">' . $row->class . '</td>
