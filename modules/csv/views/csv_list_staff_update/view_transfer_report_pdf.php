...
$mpdf = new mPDF();
$title = 'ស្ថិតិមន្រ្តីរាជការ ផ្ទេរក្របខណ្ឌមន្ត្រីចូល';
...
$body = '<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;font-family: khmermef1; width: 100%; text-align: center;">
           <thead>
            <tr style="background-color: lightgrey;">
                ...
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px">មុខតំណែងចាស់</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px ">អង្គភាពចាស់</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px ">មុខតំណែងថ្មី</th>
                <th style="border: 1px solid blue; font-family: KhmerOS; font-size:11px ">ផ្ទេរទៅអង្គភាពថ្មី</th>
    ...
    if ($getleader->num_rows() > 0) {
        ...
        foreach ($getleader->result() as $row) {
            $body .= '<tr>
                        ...
                        <td style="height: 30px;">' . $row->position. '</td>
                       
                        <td style="height: 30px;">' . $row->department. '</td>
                       
                        <td style="height: 30px;">' . $row->current_role_in_khmer . '</td>
                        <td style="height: 30px;">' . $row->unit_name . '</td>
                        
                        <td style="height: 30px;">' . date('d-M-Y', strtotime($row->stop_date)) . '</td>
