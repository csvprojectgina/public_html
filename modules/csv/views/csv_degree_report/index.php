...
<div class="panel panel-default">
    <div class="panel-heading thumbnail btn-group">
        <h3 class="panel-title">
            ...
            <?= t('ស្ថិតិមន្រ្តី តាមប្រភេទសញ្ញាបត្រ និងកម្រិតសញ្ញាបត្រ') ?>
        </h3>
    </div>
        ...
        <div style="margin: -10px 0 40px 0;vertical-align: middle;">
                <!-- <span style="float: left;margin: 5px 0 0 0;">
                    ...
                    <select name="retire_by_year" id="by_year"
                        ...
                        <!-- <?php
                        $preyear = date("Y", strtotime("-40 year"));
    ...
    <form class="form-horizontal" role="form" action="<?= site_url('csv/csv_report/pdf') ?>" method="post">
        ...
        <table cellpadding="0" cellspacing="0" border="1"
            ...
            <tr style="background-image: linear-gradient(to bottom,#f5f5f5 0,#e8e8e8 100%);background-repeat: repeat-x;">
                ...
                <th style="text-align: center; vertical-align: middle;"><?= t('សញ្ញាបត្រ') ?></th>
                <th style="text-align: center; vertical-align: middle;"><?= t('កម្រិតសញ្ញាបត្រ') ?></th>
                <th style="text-align: center; vertical-align: middle;"><?= t('កាលបរិច្ឆេទ') ?></th>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            url: '<?= site_url('csv/csv_degree_report/get_csv_degree_report') ?>',
            type: 'post',
            datatype: 'json',
            beforeSend: function () {
    ...
    $(document).on('click', '#btn_print', function (e) {
        ...
        var by_year = $('#by_year').val();
        var win = window.open('<?= site_url('csv/csv_degree_report/degree_report_pdf') ?>', '_blank');
        if (win) {
