...
switch ($unit) {
    ...
    case 1:
        ...
        //$general_dep_name = $this->input->get('general_dep_name');
        ...
        $getleader = $this->db->query(" {$strsql} AND w.unit = {$queryunit->id}  AND w.current_role_id =1");
        ...
        if ($getleader->num_rows() == 1) {
            ...
            $has_profile = is_null($getleader->row()->reference_file )?' ':empty($getleader->row()->reference_file )?' ':'  <span class="glyphicon glyphicon-list-alt has-profile" aria-hidden="true"></span> ';

            $get_id_csv[$k] = $getleader->row()->id;

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">1. ថ្នាក់ដឹកនាំក្រសួង​</td>    </tr>';

            $body .= ' <tr><td>1<div class="btn-group actionrow"><button  class="btn btn-xs dropdown-toggle btn-danger" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    សកម្មភាព <span class="caret"></span></button> <ul class="dropdown-menu"><li><a href="'. site_url('csv/csv_info/edit/'.$getleader->row()->id).'" target="_blank">កែប្រែ</a></li><li><a href="'. site_url('csv/csv_info/view_profile_pdf/'.$getleader->row()->id).'" target="_blank">ប្រវត្តិរូប</a></li></ul></div></td> <td>' . $getleader->row()->civil_servant_id . '</td><td style="text-align:left">' . $getleader->row()->lastname . ' ' . $getleader->row()->firstname . $has_profile.'</td> <td>' . $getleader->row()->gender . '</td><td>' . $getleader->row()->dateofbirth . '</td> <td>' . $getleader->row()->current_role_in_khmer . '</td><td>' . $getleader->row()->levelsalary . '</td><td>' . $getleader->row()->mobile_phone . '</td></tr>';
        ...
        $query_get_currentrole = $this->db->query("SELECT * FROM currentrole WHERE id  IN (2,3,4,20,16) ORDER BY FIELD(id,2,3,4,20,16)");

        $getoffice = '7. អគ្កនាយករដ្ឋបាល';

        $where .= ' AND w.general_department =7 AND w.current_role_id IN (5,6,15,17) AND w.department NOT IN(71,68,70,69,72)';



        $title_dep_office = '2.នាយកដ្ឋាន រដ្ឋបាល និង កិច្ចការទួទៅ';



        $where_depar .= ' AND w.general_department =7 AND w.department =69 AND w.current_role_id IN (8,7,15,17)  AND w.work_office NOT IN (24,26,25,27) ';
        ...
        $where_office_b5 = 'AND w.general_department =7 AND w.department =68 AND w.current_role_id IN (8,7,15,17) AND w.work_office NOT IN(19,240,23,20) ';
        ...
        $where_office_b9 = ' AND w.general_department =7 AND w.department =70 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(28,30,29,31)';
        ...
        $where_office_b14 = ' AND w.general_department =7 AND w.department =71 AND w.current_role_id IN (7,8,17,15)  AND w.work_office NOT IN (32,36,33)';
        ...
        $where_office_b18 = ' AND w.general_department =7 AND w.department =72 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(34,35)  ';
        ...
        $where_office_b26 = ' AND w.general_department =3 AND  w.current_role_id IN (5,6,17) AND w.work_office NOT IN (50,56,58,57,53,55,54,51,52) ';
        ...
        $where_office_b28 = ' AND w.general_department =3 AND w.department =97 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(56,58,57) ';
        ...
        $where_office_b32 = ' AND w.general_department =3 AND w.department =96 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(53,55,54) ';
        ...
        $where_office_b38 = ' AND w.general_department =3 AND w.department =93 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(50,51,52)  ';
        ...
        $where_office_b45 = ' AND w.general_department =2  AND w.current_role_id IN (5,6,15) AND w.work_office NOT IN(39,37,38) AND w.department NOT IN(86,87,92)   ';



        $title_office_b46 = '  ខ. ថ្នាក់ដឹកនាំនាយកដ្ឋានស្រាវជ្រាវ និងបទប្បញ្ញាត្តិ  ';

        $where_office_b46 = ' AND w.general_department =2 AND w.department =86 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(39,37,38)  ';
        ...
        $where_office_b50 = ' AND w.general_department =2 AND w.department =87 AND w.current_role_id IN (7,8,17,15)  AND w.work_office NOT IN(40,49,41)';



        $title_office_b51 = ' ការិយាល័យ​នគរូនីយកម្ម ';

        $where_office_b51 = ' AND w.general_department =2 AND w.department =87 AND w.current_role_id IN (9,10,15,16,17) AND w.work_office=40 ';
        ...
        $where_office_b54 = ' AND w.general_department =2 AND w.department =92 AND w.current_role_id IN (7,8,15,17)  AND w.work_office NOT IN(44,46,45)';
        ...
        $title_office_b590 = '5.3 នាយកដ្ឋាននគរូបនីយកម្ម ';

        $where_office_b590 = ' AND w.general_department =2 AND w.department =87 AND w.current_role_id IN (16) ';



        $title_office_b60 = 'ក.ថ្នាក់ដឹកនំាអគ្គនាយកដ្ឋានសុរិយោដី និងភូមិសាស្រ្ត ';

        $where_office_b60 = ' AND w.general_department =8 AND  w.current_role_id IN (5,6,15,17) AND w.department NOT IN(98,99,100,101,102,103,104)';



        $title_office_b61 = 'ខ.1. ថ្នាក់ដឹកនាំនាយកដ្ឋានគ្រប់គ្រងដីធ្លី ';

        $where_office_b61 = ' AND w.general_department =8 AND w.department =99 AND w.current_role_id IN (8,7,15,17) AND w.work_office NOT IN(62,65,64,66,67)  ';



        $title_office_b62 = 'គ.1.ការិយាល័យសហប្រតិបត្តិការ';

        $where_office_b62 = ' AND w.general_department =8 AND w.department=99 AND w.work_office=62 AND w.current_role_id IN (9,10,15,16,17)  ';
        ...
        $where_office_b66 = ' AND w.general_department =8 AND w.department=101 AND w.current_role_id IN (7,8,15,17) AND  w.work_office NOT IN(72,74,73)  ';
        ...
        $where_office_b70 = ' AND w.general_department =8 AND w.department=98 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(59,60,63)  ';
        ...
        $where_office_b74 = ' AND w.general_department =8 AND w.department=100 AND w.current_role_id IN (7,8,15,17)  AND w.work_office NOT IN(68,69,70,71)';
        ...
        $where_office_b79 = ' AND w.general_department =8 AND w.department=103  AND w.current_role_id IN (7,8,15,17)  AND w.work_office NOT IN(79,75,78,76)';
        ...
        $where_office_b84 = ' AND w.general_department =8 AND w.department=104 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(80,81,82,83) ';
        ...
        $where_office_b91 = ' AND w.general_department =9  AND w.current_role_id IN (5,6,15,17) AND w.department NOT IN(90,108,107,106,105)';



        $title_office_b92 = 'ខ.ថ្នាក់ដឹកនំា​នាយកដ្ឋានបទប្បញ្ញត្តិ ផែនការ និងទំនាក់ទំនងសហប្រតិបត្តិការការងារលំនៅឋាន';

        $where_office_b92 = ' AND w.general_department =9 AND w.department=105 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN (87,84,86,85) ';
        ...
        $where_office_b97 = ' AND w.general_department =9 AND w.department=107 AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(94,92,93,91)';
        ...
        $where_office_b102 = ' AND w.general_department =9 AND w.department=106  AND w.current_role_id IN (7,8,15,17)  AND w.work_office NOT IN(90,231,89,88)';
        ...
        $where_office_b107 = ' AND w.general_department =9 AND w.department=108  AND w.current_role_id IN (7,8,15,17)  AND w.work_office NOT IN(95,96,97,98)';
        ...
        $title_office_b1110 = 'នាយកដ្ឋានបច្ចេកទេស និងអភិវឌ្ឍលំនៅឋាន';

        $where_office_b1110 = ' AND w.general_department =9 AND w.department=106  AND w.current_role_id IN (16) ';

        

        $title_office_b1111 = 'នាយកដ្ឋានមូលនិធិ និងឥណទានលំនៅឋាន';

        $where_office_b1111 = ' AND w.general_department =9 AND w.department=107  AND w.current_role_id IN (16) ';

        

        $title_office_b112 = 'ក. ថ្នាក់ដឹកនំាអគ្គាធិការដ្ឋាន';

        $where_office_b112 = ' AND w.general_department =10   AND w.current_role_id IN (5,6,15,17 ) AND w.department NOT IN(89,91) ';



        $title_office_b113 = 'ខ. ថ្នាក់ដឹកនាំនាយកដ្ឋានត្រួតពិនិត្យ និងទទួលពាក្យបណ្តឹង';

        $where_office_b113 = ' AND w.general_department =10  AND w.department=89  AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(111,112,113) ';
        ...
        $where_office_b117 = ' AND w.general_department =10  AND w.department=91  AND w.current_role_id IN (7,8,15,17) AND w.work_office NOT IN(115,114,116)';
        ...
        $where_office_b120 = ' AND w.general_department =10  AND w.department=91  AND w.current_role_id IN (9,10,15,16,17) AND w.work_office=116';
         ...
         $title_office_b1200 = 'នាយកដ្ឋានត្រួតពិនិត្យ និងទទួលពាក្យបណ្តឹង';

        $where_office_b1200 = ' AND w.general_department =10  AND w.department=89  AND w.current_role_id IN (16) ';



        $title_office_b1201 = 'នាយកដ្ឋានអធិការកិច្ចភូមិបាល';

        $where_office_b1201 = ' AND w.general_department =10  AND w.department=91  AND w.current_role_id IN (16) ';

        

        $title_office_b121 = 'ក.ថ្នាក់ដឹកនំានាយកដ្ឋាន​សវនកម្មផ្ទៃក្នុង';

        $where_office_b121 = ' AND  w.department=112   AND w.current_role_id IN (8,7,15,17) AND w.work_office NOT IN(100,101,102,103)';
        ...
        $where_office_b126 = ' AND  w.department=111   AND w.current_role_id IN (8,7,15,17) AND w.work_office NOT IN(104,105,106)';
        ...
        $title_office_b131 = ' មជ្ឈមណ្ឌលបណ្តុះបណ្តាលវិជ្ជាជីវៈ';

        $where_office_b131 = ' AND  w.department=115   AND w.current_role_id IN (7,8,9,10,15,16,17)';

        

        $title_office_b132 = ' គណៈកម្មាធិការរៀបចំដែនដី នគរូបនីយកម្មថ្នាក់ជាតិ';

        $where_office_b132 = ' AND  w.department=114   AND w.current_role_id IN (7,8,9,10,15,16,17)';

        

        $title_office_b133 = ' សាលាបណ្តុះបណ្តាលវិជ្ជាជីវៈ';

        $where_office_b133 = ' AND  w.department=116   AND w.current_role_id IN (7,8,9,10,15,16,17)';

        

        $title_office_b135 = ' គណៈកម្មាធិការជាតិគ្រប់គ្រង និងអភិវឌ្ឍន៍តំបន់ឆ្នេរសមុទ្រកម្ពុជា';

        $where_office_b135 = ' AND  w.department=117   AND w.current_role_id IN (7,8,9,10,15,16,17)';

        

        $title_office_b134 = ' អង្គភាពលទ្ធកម្ម';

        $where_office_b134 = ' AND  w.department=118   AND w.current_role_id IN (7,8,9,10,15,16,17)';
        ...
        foreach ($query_get_currentrole->result() as $rowcurrent) {
            ...
            $officerunit = $this->db->query(" $strsql AND
                          ...
                          w.unit = {$queryunit->id}  AND w.current_role_id ={$rowcurrent->id} AND w.general_department NOT IN (2,3,7,8,9,10) AND w.department NOT IN (111,112,113,114,115,116,117,118,86,87,92,93,96,97,68,69,70,71,72,98,99,100,101,103,104,105,106,107,108,89,91)   ORDER BY w.current_role_id ASC");
            ...
            if ($officerunit->num_rows() > 0) {
                ...
                foreach ($officerunit->result() as $row) {
                     ...
                     $has_profile = is_null($row->reference_file )?' ':empty($row->reference_file )?' ':'  <span class="glyphicon glyphicon-list-alt has-profile" aria-hidden="true"></span> ';$body .= ' <tr><td>' . ++$k . '<div class="btn-group actionrow"><button  class="btn btn-xs dropdown-toggle btn-danger" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                    សកម្មភាព <span class="caret"></span></button> <ul class="dropdown-menu"><li><a href="'. site_url('csv/csv_info/edit/'.$row->id).'" target="_blank">កែប្រែ</a></li><li><a href="'. site_url('csv/csv_info/view_profile_pdf/'.$row->id).'" target="_blank">ប្រវត្តិរូប</a></li></ul></div></td> <td>' . $row->civil_servant_id . '</td><td style="text-align:left">' . $row->lastname . ' ' . $row->firstname .$has_profile.' </td> <td>' . $row->gender . '</td><td>' . $row->dateofbirth . '</td> <td>' . $row->current_role_in_khmer . '</td><td>' . $row->levelsalary . '</td><td>' . $row->mobile_phone . '</td></tr>';
     ...
     /*   $officerunit = $this->db->query(" {$strsql}   {$where_office_b1}
                  ...
                  ORDER BY w.current_role_id ASC");
        ...
        */
        ...
        if ($officerunit->num_rows() > 0) {
            ...
            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px"> ' . $getoffice . '</td>    </tr>';
        ...
        if ($officerunit->num_rows() > 0) {
         ...
         $officerunit = $this->db->query(" {$strsql}   {$where_office_b590}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b590 . '  </tr>';
        ...
        if ($officerunit->num_rows() > 0) {
            ...
            $officerunit = $this->db->query(" {$strsql}   {$where_office_b1110}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b1110 . '  </tr>';
         ...
         $officerunit = $this->db->query(" {$strsql}   {$where_office_b1111}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b1111 . '  </tr>';
        ...
        if ($officerunit->num_rows() > 0) {
          ...
          $officerunit = $this->db->query(" {$strsql}   {$where_office_b1200}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b1200 . '  </tr>';
         ...
         $officerunit = $this->db->query(" {$strsql}   {$where_office_b1201}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b1201 . '  </tr>';
        ...
        if ($officerunit->num_rows() > 0) {
           ...
           $officerunit = $this->db->query(" {$strsql}   {$where_office_b131}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b131 . '  </tr>';
        ...
        $officerunit = $this->db->query(" {$strsql}   {$where_office_b132}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b132 . '  </tr>';
          ...
          $officerunit = $this->db->query(" {$strsql}   {$where_office_b133}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b133 . '  </tr>';
         ...
         $officerunit = $this->db->query(" {$strsql}   {$where_office_b135}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b135 . '  </tr>';
         ...
         $officerunit = $this->db->query(" {$strsql}   {$where_office_b134}

                  ORDER BY w.current_role_id ASC");

        if ($officerunit->num_rows() > 0) {

            $body .= '<tr> <td colspan="8" style="background-color:#eee;text-align:left; height:40px">' . $title_office_b134 . '  </tr>';
    ...
    case 5:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកំពង់ឆ្នាំង |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'" ;
    ...
    case 17:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តព្រះវិហារ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND  w.province_office NOT IN(147,149,148) AND w.land_official NOT IN(48,54,52,55,53,50,51,49) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (17) ";
    ...
    case 8:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកំពត |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND  w.province_office NOT IN(212,214,213,216,215) AND    w.land_official NOT IN(177,185,180,181,179,182,178,183) ";

        $arr[] = "ការិយាល័យរដ្ឋបាល |  {$strsql} AND w.unit = {$unit} AND  w.province_office=212 AND w.current_role_id IN (9,10,15,16,17,21) AND    w.land_official NOT IN(177,185,180,181,179,182,178,183)";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=214 AND w.current_role_id IN (9,10,15,16,17,21) AND    w.land_official NOT IN(177,185,180,181,179,182,178,183)";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និងសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=213 AND w.current_role_id IN (9,10,15,16,17,21) AND    w.land_official NOT IN(177,185,180,181,179,182,178,183)";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=216 AND w.current_role_id IN (9,10,15,16,17,21) AND    w.land_official NOT IN(177,185,180,181,179,182,178,183)";

        $arr[] = " ការិយាល័យសំណង់  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=215 AND w.current_role_id IN (9,10,15,16,17,21) AND    w.land_official NOT IN(177,185,180,181,179,182,178,183)";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងកំពត |  {$strsql} AND w.unit = {$unit} AND    w.land_official =177 AND w.current_role_id IN (18,19,16,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអង្គរជ័យ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =185 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកដងទង់  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =180 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដីនគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកឈូក |  {$strsql} AND w.unit = {$unit} AND    w.land_official =181 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកទឹកឈូ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =179 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកបន្ទាយមាស |  {$strsql} AND w.unit = {$unit} AND    w.land_official =182 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកំពង់ត្រាច |  {$strsql} AND w.unit = {$unit} AND    w.land_official =178 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកជុំគីរី  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =183 AND w.current_role_id IN (18,16,19,21,17,15) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (17) ";
    ...
    case 4:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកំពង់ចាម |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND  w.province_office NOT IN(235,194,192,195,193,236) AND    w.land_official NOT IN(144,145,146,151,147,148,149,150,153,152) ";

        $arr[] = "ការិយាល័យរដ្ឋបាល |  {$strsql} AND w.unit = {$unit} AND  w.province_office=235 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=194 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និងសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=192 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=195 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = " ការិយាល័យសំណង់  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=193 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = " ការិយាល័យអភិរក្សសុរិយោដី  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=236 AND w.current_role_id IN (9,10,15,16,17) ";





        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងកំពង់ចាម |  {$strsql} AND w.unit = {$unit} AND    w.land_official =144 AND w.current_role_id IN (18,19,16,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកំពង់សៀម  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =145 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកព្រៃឈរ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =146 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដីនគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកងមាស |  {$strsql} AND w.unit = {$unit} AND    w.land_official =151 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកជើងព្រៃ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =147 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកបាធាយ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =148 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកចំការលើ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =149 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកស្ទឹងត្រង់  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =150 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកោះសូទិន  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =153 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកស្រីសន្ធរ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =152 AND w.current_role_id IN (18,16,19,21,17,15) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (17) ";
    ...
    case 20:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តរតនគីរី |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND  w.province_office NOT IN(160,162,161,163) AND w.land_official NOT IN(67,68,69,70,71,72,73,74,75) ";

        $arr[] = "ការិយាល័យរដ្ឋបាល |  {$strsql} AND w.unit = {$unit} AND  w.province_office=160 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=162 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និងសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=161 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=163 AND w.current_role_id IN (9,10,15,16,17) ";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងបានលុង |  {$strsql} AND w.unit = {$unit} AND    w.land_official =67 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអូរយ៉ាដាវ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =68 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកួនមុំ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =69 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដីនគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអណ្តូងមាស |  {$strsql} AND w.unit = {$unit} AND    w.land_official =70 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកលំផាត់  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =71 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកថតាវែង |  {$strsql} AND w.unit = {$unit} AND    w.land_official =72 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកបរកែវ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =73 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកវើនសៃ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =74 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអូរជុំ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =75 AND w.current_role_id IN (18,16,19,21,17,15) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit}   AND w.current_role_id IN (17) ";
    ...
    case 25:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តត្បូងឃ្មុំ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND  w.province_office NOT IN(181,184,182,185,183) AND w.land_official NOT IN(114,115,116,117,118,119,120) ";

        $arr[] = "ការិយាល័យរដ្ឋបាល |  {$strsql} AND w.unit = {$unit} AND  w.province_office=181 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=184 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និងសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=182 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=185 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=183 AND w.current_role_id IN (9,10,15,16,17) ";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងសួង |  {$strsql} AND w.unit = {$unit} AND    w.land_official =114 AND w.current_role_id IN (18,16,19,21,17,15)  ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកពញាក្រែក  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =115 AND w.current_role_id IN (18,16,19,21,17,15)  ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអូររាំងឪ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =116 AND w.current_role_id IN (18,16,19,21,17,15)  ";

        $arr[] = "ការិយាល័យរៀបចំដែនដីនគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកតំបែរ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =117 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកមេមត់  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =118 AND w.current_role_id IN (18,16,19,21,17,15)  ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកក្រូចឆ្មា |  {$strsql} AND w.unit = {$unit} AND    w.land_official =119 AND w.current_role_id IN (18,16,19,21,17,15)  ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកត្បូងឃ្មុំ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =120 AND w.current_role_id IN (18,16,19,21,17,15)  ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit}   AND w.current_role_id IN (17) ";
    ...
    case 15:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តប៉ៃលិន |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND  w.province_office NOT IN(134,133,184,135,138,137) AND w.land_official NOT IN(41,42) ";
        ...
        $arr[] = "ការិយាល័យរៀបចំដែនដី និងនគរូបនីយកម្ម |  {$strsql} AND w.unit = {$unit} AND  w.province_office=134 AND w.current_role_id IN (9,10,15,16) ";
        ...
        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងប៉ៃលិន |  {$strsql} AND w.unit = {$unit} AND    w.land_official =41 AND w.current_role_id IN (18,19,16,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកសាលាក្រៅ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =42 AND w.current_role_id IN (18,16,19,21,15,17) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit}   AND w.current_role_id IN (17) ";
    ...
    case 13:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តមណ្ឌលគីរី |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,15,21)AND  w.province_office NOT IN(164,166,167,165) AND w.land_official NOT IN(76,77,78,79,80)";



        $arr[] = "ការិយាល័យរដ្ឋបាល និង កិច្ចការទូទៅ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=164 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=166 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=167 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=165 AND w.current_role_id IN (9,10,15,16,17) ";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងសែនមនោរម្យ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =76 AND w.current_role_id IN (18,19,16,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកពេជ្រាដា  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =77 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកែវសីមា  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =78 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកកោះញែក  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =79 AND w.current_role_id IN (18,16,19,21,17,15) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអូរាំង  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =80 AND w.current_role_id IN (18,16,19,21,17,15) ";
    ...
    case 12:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តក្រចេះ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,15)AND  w.province_office NOT IN(151,152,154,155,153) AND w.land_official NOT IN(56,57,58,59,60,61)";



        $arr[] = "ការិយាល័យរដ្ឋបាល  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=151 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និង នគររុបនីយកម្ម |  {$strsql} AND w.unit = {$unit} AND  w.province_office=152 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=154 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=155 AND w.current_role_id IN (9,10,15,16,21,17) ";

        $arr[] = "ការិយាល័យសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=153 AND w.current_role_id IN (9,10,15,16,17) ";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងក្រចេះ |  {$strsql} AND w.unit = {$unit} AND    w.land_official =56 AND w.current_role_id IN (18,19,16,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកឆ្លូង  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =57 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកសំបូរ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =58 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកព្រែកប្រសព្វ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =59 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកស្នួល  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =60 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកចិត្របុរី |  {$strsql} AND w.unit = {$unit} AND    w.land_official =61 AND w.current_role_id IN (18,16,19,21,15,17) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit}   AND w.current_role_id IN (17) ";
    ...
    case 10:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកែប |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,15,21) AND  w.province_office NOT IN(207,209,208,210,211) AND w.land_official NOT IN(175,176) ";



        $arr[] = "ការិយាល័យរដ្ឋបាល  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=207 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និង នគររុបនីយកម្ម |  {$strsql} AND w.unit = {$unit} AND  w.province_office=209 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=210 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=211 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=208 AND w.current_role_id IN (9,10,15,16,17) ";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងកែប |  {$strsql} AND w.unit = {$unit} AND    w.land_official =175 AND w.current_role_id IN (18,19,16,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកដំណាកចង្អើរ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =176 AND w.current_role_id IN (18,16,19,21,15,17) ";
    ...
    case 14:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តឧត្តរមានជ័យ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,15,21) AND  w.province_office NOT IN(139,140,141,143,238) AND w.land_official NOT IN(43,44,45,46,47) ";



        $arr[] = "ការិយាល័យរដ្ឋបាល  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=139 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និង នគររុបនីយកម្ម |  {$strsql} AND w.unit = {$unit} AND  w.province_office=140 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសុរិយោដី និងភូមិសាស្រ្ត |  {$strsql} AND w.unit = {$unit} AND  w.province_office=141 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យលំនៅឋាន​ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=143 AND w.current_role_id IN (9,10,15,16,17) ";

        $arr[] = "ការិយាល័យសំណង់ |  {$strsql} AND w.unit = {$unit} AND  w.province_office=238 AND w.current_role_id IN (9,10,15,16,17) ";



        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ក្រុងសំរោង |  {$strsql} AND w.unit = {$unit} AND    w.land_official =43 AND w.current_role_id IN (18,19,16,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកចុងកាល់  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =44 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកត្រពាំងប្រាសាទ  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =45 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកបន្ទាយអំពិល  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =46 AND w.current_role_id IN (18,16,19,21,15,17) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកអន្លងវែង  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =47 AND w.current_role_id IN (18,16,19,21,15,17) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit}   AND w.current_role_id IN (17) ";
    ...
    case 21:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តសៀមរាប |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 18:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តព្រៃវែង |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 22:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តស្ទឹងត្រែង |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 11:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកោះកុង |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
        ...
        $arr[] = "ការិយាល័យរៀបចំដែនដី និង នគររុបនីយកម្ម |  {$strsql} AND w.unit = {$unit} AND  w.province_office=224 AND w.current_role_id IN (9,10,15,16,17) ";
        ...
        $arr[] = "ការិយាល័យរៀបចំដែនដី នគរូបនីយកម្ម សំណង់ និងភូមិបាល ស្រុកមណ្ឌលសីមា  |  {$strsql} AND w.unit = {$unit} AND    w.land_official =192 AND w.current_role_id IN (18,16,19,21) ";
...
//        $arr[] = "កម្មសិក្សាការី  |  {$strsql} AND w.unit = {$unit}   AND w.current_role_id IN (17) ";
    ...
    case 19:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តពោធិសាត់ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'" ;
    ...
    case 2:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តបន្ទាយមានជ័យ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,15,21) AND  w.province_office = 'NULL' AND w.land_official = 'NULL'";



        $arr[] = "ការិយាល័យរដ្ឋបាល  |  {$strsql} AND w.unit = {$unit} AND  w.province_office=142 AND w.current_role_id IN (9,10,15,16) ";

        $arr[] = "ការិយាល័យរៀបចំដែនដី និង នគរូបនីយកម្ម |  {$strsql} AND w.unit = {$unit} AND  w.province_office=144 AND w.current_role_id IN (9,10,15,16) ";
    ...
    case 3:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តបាត់ដំបង |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,16,15,21) AND  w.province_office in ( 'NULL',0) AND w.land_official in ( 'NULL',0) "; 
    ...
    case 6:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកំពង់ស្ពឹ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 16:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តព្រះសីហនុ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 7:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកំពង់ធំ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 9:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តកណ្តាល |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,17,15,21) AND  w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 23:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តស្វាយរៀង |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 24:
        ...
        $arr[] = "មន្ទីរ ដនសស ខេត្តតាកែវ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    case 31:
        ...
        $arr[] = "មន្ទីរ ដនសស រាជធានីភ្នំពេញ |  {$strsql} AND w.unit = {$unit} AND w.current_role_id IN (11,12,15,17,21) AND w.province_office = 'NULL' AND w.land_official = 'NULL'";
    ...
    default :redirect('csv/home/index');
