        ...
        <div class="panel-body">
            ...
            <div style="margin: -10px 0 40px 0;vertical-align: middle;">
                ...
                <span style="float: left;margin: 5px 0 0 0;">
                    ...
                    <select id="s_dis" style="height: 30px;">
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        ...
                        <span>
                            ...
                            <ul class="pagination" id="pagination-grid" style="margin-top: 5px;">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            url: '<?= site_url('csv/csv_info/get_num_dip') ?>', type: 'post', datatype: 'json', async: false, beforeSend: function () {
            ...
            if (id > 0) {
                ...
                if (confirm('តើអ្នកពិតជាលុយ?')) {
                    ...
                    $.ajax({
                        ...
                        url: '<?= site_url('csv/csv_info/delete') ?>', type: 'POST', dataType: 'html', data: {
            ...
            , success: function (data) {
                ...
                if (record.length > 0) {
                    ...
                    $.each(record, function (i, row) {
                        ...
                        tr += "<tr data-id='" + row.id + "'data-href='<?= site_url('csv/csv_info/edit') ?>/" + row.id + "'class='editor' target='_parent'>" + // "<td style='text-align: center;'>" + ri++ + "</td>" +

                                "<td style='text-align: center;'>" + row.civil_servant_id + "</td>" + "<td style='text-align: left;'>" + row.lastname + ' ' + row.firstname + "</td>" + // "<td style='text-align: left;'>" + row.firstname + "</td>" +

                                "<td style='text-align: left;'>" + row.gender + "</td>" + "<td style='text-align: left;'>" + row.dateofbirth + "</td>" + // "<td style='text-align: left;'>" + row.date_in + "</td>" +

                                "<td style='text-align: left;'>" + row.current_role_in_khmer + "</td>" + // "<td style='text-align: left;'>" + row.type_of_framework + "</td>" +

                                "<td style='text-align: left;'>" + row.mobile_phone + "</td>" +

                                "<td style='text-align: left;'>" + row.office + "</td>" +

                                "<td style='text-align: left;'>" + row.unit_name + "</td>" + "</tr>";
                    ...
                    tr += "<tr>" + "<td colspan='11' style='text-align: center;'>អត់មានទិន្ន័យ!</td>" + "</tr>";
