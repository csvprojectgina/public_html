            ...
            <div class="col-sm-12">
                <div class="modal-body">
                    <div class="bs-example">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label"><?= t('បញ្ជូលអគ្គនាយកដ្ឌាន') ?></label>
                            <div class="col-sm-10">
                                    ...
                                    foreach ($gdquery as $keyrow) {
                                      ...
                                      ?>
                                        <option data-id="<?php echo @$keyrow->general_dep_id; ?>"
                                                ...
                                                value="<?php echo $keyrow->general_dep_id; ?>"
                                                <?php echo $is_selected ?>>
                                                    <?php echo @$keyrow->general_deps_name; ?>
                                        </option>
                                    <?php }; ?>
                                </select>
                        ...
                        <!--department-->
                        <div class="form-group">
                            <label for=""  class="col-sm-2 control-label" >បញ្ជូលនាយកដ្ឌាន</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="d_name" id="d_name" placeholder="បញ្ជូលនាយកដ្ឌាន" value="<?php echo @$row->d_name; ?>">
