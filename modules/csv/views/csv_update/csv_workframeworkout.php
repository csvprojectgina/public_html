...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><!--<img src="<?= base_url('assets/bs/css/images/search.gif') ?>" />​--> <?= t('មន្ត្រីគ្មានបៀវត្ស') ?></h3>
    </div>
    ...
    <div class="panel-body">
        ...
        <?php if (isset($csv_record['csv_id'])) { ?>
            ...
            <fieldset >
                <legend><?= t('បញ្ជាកមន្ត្រីគ្មានបៀវត្ស') ?></legend>
                <div class="row">
                    <form id="frm-workframeworkout" method="post">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.typeahead({
            ...
            delay: 500,
            hint: true,
            href: '<?php echo site_url('csv/csv_update/get_csv_detail?value={{id}}-{{name}}&id={{idtable}}&frm=workframeworkout') ?>',
            cancelButton: true,
            display: ["id", "name"],
            backdrop: {
    ...
    $("#frm-workframeworkout").on('submit', function (e) {
        e.preventDefault();
        ...
        if (date === '') {
            ...
            $.ajax({
                url: '<?php echo site_url('csv/csv_update/save_csv_frameworkout') ?>',
                type: "post",
                datatype: "json",
                ...
                success: function (data) {
                 ...
                 if(data.status === 'success'){
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo site_url('csv/csv_update/csv_workframeworkout/') ?>/";
                    }, 3000);
