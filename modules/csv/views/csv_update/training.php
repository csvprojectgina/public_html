...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><!--<img src="<?= base_url('assets/bs/css/images/search.gif') ?>" />​--> <?= t('មន្ត្រីទទួលបានការបណ្តុះបណ្តាលក្នុង/ក្រៅប្រទេស') ?></h3>
    </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">
                        ...
                        class="collapsed"><?= t('មន្ត្រីទទួលបានការបណ្តុះបណ្តាលក្នុង/ក្រៅប្រទេស') ?></a>
                ...
                <div class="row">
                    <form id="frm-training" method="post">
                        ...
                        <!-- edit -->
                        <div class="form-group ">
                                <label class="col-lg-2 col-md-2 text-right"><?= t('ទីកន្លែងសិក្សារ') ?></label>
                                <div class="col-lg-8 col-md-8">
                                <input type = "text"  class="form-control" id="place_train" name = "place_train" placeholder="ខេត្ត/ក្រុង/ស្រុក" data-placement="top" title="ទីកន្លែងកម្មសិក្សារ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-md-8">
                                <select name="type_train" class="form-control" id="type_train" data-placement="top" title="ប្រភេទកម្មសិក្សារ"​ required="required">
                                    ...
                                    <option value="រយះពេលវែង">រយះពេលវែង</option>
                        ...
                        <div class="form-group ">
                                <label class="col-lg-2 col-md-2 text-right"><?= t('មុខវិជ្ជាសិក្សា
                                ឫប្រធានបទ') ?></label>
                                <div class="col-lg-8 col-md-8">
                                <input type = "text"  class="form-control" id="subject_course" name = "subject_course"  placeholder="មុខវិជ្ជាសិក្សាឫប្រធានបទ" data-placement="top" title="មុខវិជ្ជាសិក្សាឫប្រធានបទ" >
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-2 col-md-2 text-right"><?= t('កំរិតនៃកម្មសិក្សារ') ?></label>
                            <div class="col-sm-8 col-md-8">
                                <select name="level_train" class="form-control" id="level_train" data-placement="top" title="កំរិតនៃកម្មសិក្សារ" required="required">
                                    <option value="">--ជ្រើសរើស--</option>
                                    <option value="មធ្យម">មធ្យម</option>
                                    <option value="ឧត្តម">ឧត្តម</option>
                        ...
                        <div class="form-group ">
                                <label class="col-lg-2 col-md-2 text-right"><?= t('ឈ្មោះសាលា') ?></label>
                                <div class="col-lg-8 col-md-8">
                                <input type = "text"  class="form-control" id="school_train" name = "school_train"  placeholder="ឈ្មោះសាលាដែលចុះកម្មសិក្សារ" data-placement="top" title="ឈ្មោះសាលាដែលចុះកម្មសិក្សារ" >
                                    
                                </div>
                        </div>

                        <div class="form-group ">
                                <label class="col-lg-2 col-md-2 text-right"><?= t('សញ្ញាប័ត្រ
                        ...
                        <div class="form-group ">
                                <label class="col-lg-2 col-md-2 text-right"><?= t('ប្រទេស') ?></label>
                                <div class="col-lg-8 col-md-8">
                                <input type = "text"  class="form-control" id="country" name = "country"  placeholder="ឈ្មោះប្រទេសដែលទៅកម្មសិក្សារ" data-placement="top" title="ឈ្មោះប្រទេសដែលទៅកម្មសិក្សារ" required="required">
                            ...
                            <div class="form-group changeDate">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="" class="form-control datepick" id="txtDate" name="startDate"​​ data-placement="top" title="ថ្ងៃ ខែ ឆ្នាំ​​ ចាប់ផ្តើមកម្មសិក្សា" required="required"/>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-10 col-md-10">
                                    <div class="input-group">
                                        <span class="input-group-addon glyphicon glyphicon-calendar"></span>  
                                        <input type="text" value="" class="form-control datepick" id="secondDate" name="endDate" data-placement="top" title="ថ្ងៃ ខែ ឆ្នាំ​​ បញ្ចប់កម្មសិក្សារ" required="required" />
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.typeahead({
            ...
            delay: 500,
            hint: true,
            href: '<?php echo site_url('csv/csv_update/get_csv_detail?value={{id}}-{{name}}&id={{idtable}}&frm=training') ?>',
            cancelButton: true,
            display: ["id", "name"],
            backdrop: {
    ...
    $("#frm-training").on('submit', function (e) {
        e.preventDefault();
        ...
        if (date === '') {
            ...
            $.ajax({
                url: '<?php echo site_url('csv/csv_update/save_csv_training') ?>',
                type: "post",
                datatype: "json",
                ...
                success: function (data) {
                 ...
                 if(data.status === 'success'){
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo site_url('csv/csv_update/csv_training/') ?>/";
                    }, 3000);
