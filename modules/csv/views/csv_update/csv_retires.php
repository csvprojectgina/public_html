...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><!--<img src="<?= base_url('assets/bs/css/images/search.gif') ?>" />​--> <?= t('មន្ត្រីចូលនិវត្ដន៍') ?></h3>
    </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">
                            ...
                            class="collapsed"><?= t('បញ្ជាក់មន្ត្រីចូលនិវត្ដន៍') ?></a>

                        </h4>

                    </div>
                    <br>
                <!-- <legend><?= t('បញ្ជាក់មន្ត្រីចូលនិវត្ត') ?></legend> -->
                    <div class="row">
                        <form id="frm-retires" method="post">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.typeahead({
            ...
            delay: 500,
            hint: true,
            href: '<?php echo site_url('csv/csv_update/get_csv_detail?value={{id}}-{{name}}&id={{idtable}}&frm=retires') ?>',
            cancelButton: true,
            display: ["id", "name"],
            backdrop: {
    ...
    $("#frm-retires").on('submit', function (e) {
        e.preventDefault();
        ...
        if (date === '') {
            ...
            $.ajax({
                url: '<?php echo site_url('csv/csv_update/save_csv_retires') ?>',
                type: "post",
                datatype: "json",
                ...
                success: function (data) {
                 ...
                 if(data.status === 'success'){
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo site_url('csv/csv_update/csv_retires/') ?>/";
                    }, 3000);
