...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><!--<img src="<?= base_url('assets/bs/css/images/search.gif') ?>" />​--> <?= t('បាត់បង់សម្បទាវិជ្ជាជីវៈ') ?></h3>
    </div>
    ...
    <div class="panel-body">
        ...
        <?php if (isset($csv_record['csv_id'])) { ?>
            ...
            <fieldset >
                <legend><?= t('បញ្ជាក់ការបាត់បង់សម្បទាវិជ្ជាជីវៈ') ?></legend>
                <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.typeahead({
            ...
            delay: 500,
            hint: true,
            href: '<?php echo site_url('csv/csv_update/get_csv_detail?value={{id}}-{{name}}&id={{idtable}}&frm=terminate') ?>',
            cancelButton: true,
            display: ["id", "name"],
            backdrop: {
    ...
    $("#frm-terminate").on('submit', function (e) {
        ...
        if (date === '') {
            ...
            $.ajax({
                url: '<?php echo site_url('csv/csv_update/save_csv_teminate') ?>',
                type: "post",
                datatype: "json",
                ...
                success: function (data) {
                 ...
                 if(data.status === 'success'){
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo site_url('csv/csv_update/csv_terminate/') ?>/";
                    }, 3000);
