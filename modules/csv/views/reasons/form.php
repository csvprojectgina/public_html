                        ...
                        <div class="modal-body">
                          <div class="bs-example">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="reason_name" id="inputEmail" placeholder="បញ្ជូលអង្គភាព" value="<?php echo @$row->reason_name; ?>">
                                    <input type="hidden" name="id" value="<?php echo @$row->rea_id; ?>">
                                </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3 text-right  col-sm-3" style="padding:0px;">
                                    <div class="btn-group  btn-group-lg">
                                      ...
                                      <button type="button" class="btn btn-default glyphicon glyphicon-arrow-left" id="back"> </button>
                                    </div>
                                  </div>
                                </div>
                        </div>
