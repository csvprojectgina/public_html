<form class="form-horizontal" role="form"> 
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><img src="<?= base_url('assets/bs/css/images/search.gif') ?>" />​ <?= t('ស្វែងរកខ្សែផ្លូវ (ផែនការ)') ?></h3>
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?= site_url('rri/plan/grid') ?>"
        });
        ...
        $("body").delegate(".editor_edit", "click", function(e) {
            ...
            window.location = '<?= site_url('rri/plan/edit') ?>/' + encodeURIComponent(eid);
        });
