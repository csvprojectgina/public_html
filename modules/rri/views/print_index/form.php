...
if ($query->num_rows > 0) {
    ...
    <table align="center">
        ...
        <tr>
            <td>
                <span style="font-family: khmer mef2;">តារាងព័ត៌មានខ្សែផ្លូវតាម រាជធានី-ខេត្ត សម្រាប់<?= $str_pro_khmer ?></span>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <!------------------------------------------->
    <table width="100%" class="data" cellpadding="0" cellspacing="0" align="center" border="2" bordercolor="blue" style="font-family: khmer mef1;border-collapse: collapse;border: 2px solid blue;">
        <thead>
            <tr>
                <th rowspan="2">លរ</th>
