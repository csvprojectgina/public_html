...
$g_to3 = ($total_l_t1 + $total_l_t2 + $total_l_t3 + $total_l_t4) / 1000;
?>
...
<table align="center" class="data" border="1" bordercolor="blue" style="font-family: khmer mef1;font-size: 16px;text-align: right;vertical-align: middle;border-collapse: collapse;border: 2px solid blue;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= ($total_t1 - 0 > 0 ? $total_t1 : '') ?></td>
            <td><?= ($total_l_t1 - 0 > 0 ? $total_l_t1 : '') ?></td>
            <td><?= (($total_l_t1 - 0) > 0 ? $total_l_t1 / 100 : '') ?></td>
        </tr>
        <!-- 2 ----------------------------------->
        <tr>
            <td style="text-align: center;">២</td>
            <td style="text-align: center;">ប្រភេទទី​ ២</td>
            <td><?= ($total_t2 - 0 > 0 ? $total_t2 : '') ?></td>
            <td><?= ($total_l_t2 - 0 > 0 ? $total_l_t2 : '') ?></td>
            <td><?= (($total_l_t2 - 0) > 0 ? $total_l_t2 / 100 : '') ?></td>
        </tr>
        <!-- 3 ----------------------------------->
        <tr>
            <td style="text-align: center;">៣</td>
            <td style="text-align: center;">ប្រភេទទី​ ៣</td>
            <td><?= ($total_t3 - 0 > 0 ? $total_t3 : '') ?></td>
            <td><?= ($total_l_t3 - 0 > 0 ? $total_l_t3 : '') ?></td>
            <td><?= (($total_l_t3 - 0) > 0 ? $total_l_t3 / 100 : '') ?></td>
        </tr>
        <!-- 4 ----------------------------------->
        <tr>
            <td style="text-align: center;">៤</td>
            <td style="text-align: center;">ប្រភេទទី​ ៤</td>
            <td><?= ($total_t4 - 0 > 0 ? $total_t4 : '') ?></td>
            <td><?= ($total_l_t4 - 0 > 0 ? $total_l_t4 : '') ?></td>
            <td><?= (($total_l_t4 - 0) > 0 ? $total_l_t4 / 100 : '') ?></td>
        </tr>         
    </tbody>
    <tfoot style="font-weight: bold;text-align: center;border-top: 2px solid blue;">
        <tr>
            <td colspan="2">សរុបរួម</td>
            <td><?= ($g_to1 - 0 > 0 ? $g_to1 : '') ?></td>
            <td><?= ($g_to2 - 0 > 0 ? $g_to2 : '') ?></td>
            <td><?= ($g_to3 - 0 > 0 ? $g_to3 : '') ?></td>
        </tr>
    </tfoot>
</table>
