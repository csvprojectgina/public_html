<form class="form-horizontal" role="form"> 
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><img src="<?= base_url('assets/bs/css/images/search.gif') ?>" />​ <?= t('') ?></h3>
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?= site_url('rri/maintenance/grid') ?>"
        });
        ...
        $("body").delegate(".editor_edit", "click", function(e) {
            ...
            window.location = '<?= site_url('rri/maintenance/edit') ?>/' + encodeURIComponent(eid);
        });
        ...
        /* $("body").delegate(".editor_remove", "click", function(e) {
         ...
         var id = tr.attr('id') - 0;
         var eid = (id);
         // window.location = '<?= site_url('rri/maintenance/delete') ?>/' + encodeURIComponent(eid);
         }
         }); */
