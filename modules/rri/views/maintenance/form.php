...
<form class="form-horizontal" role="form" action="<?= site_url('rri/plan/insert') ?>" method="post">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <?php } else {
                ?>                
                <h3 class="panel-title"><img src="<?= base_url('assets/bs/css/images/edit_road_detail.gif') ?>" /> <?= t('Edit Maintenance') . (isset($query_pro_id->khmer_name) ? t('​​ : ខេត្ត ') . $query_pro_id->khmer_name : '') ?></h3>
            <?php }
            ?>
        ...
        <div class="panel-body"> 
            ...
            <div id="tabs">
                ...
                <!-- tab4 ----------------------------->                
                <div id = "tabs-4">
                    <div style="border: 1px solid gray;padding: 10px 10px 0 10px;width: 50%">
                        <div class = "form-group">
                        <div class="col-sm-10">
                            <?php $use_gps = isset($row_->use_gps) ? $row_->use_gps : '' ?>
                            <input type="checkbox" value="1" <?= ($use_gps == 1 ? "checked" : "") ?> id="use_gps" name="use_gps">
                            <label for = "use_gps"><?= t('Routine Maintenance') ?></label>
                        </div>
                    </div>
                    <div class = "form-group">
                        <div class="col-sm-10">
                            <?php $use_gps = isset($row_->use_gps) ? $row_->use_gps : '' ?>
                            <input type="checkbox" value="2" <?= ($use_gps == 2 ? "checked" : "") ?> id="use_gps" name="use_gps">
                            <label for = "use_gps"><?= t('Periodic Maintenance') ?></label>
                        </div>
                    </div>
                    </div>
                </div>   
...
<script type="text/javascript">
    $(function() {
        ...
        $('#back').on('click', function() {
            window.location = "<?= site_url('rri/maintenance/index') ?>";
        });
