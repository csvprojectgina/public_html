            ...
            <div id="tabs">
                ...
                <div id = "tabs-1">
                    ...
                    <div class = "form-group">
                        ...
                        <div class="col-sm-10">
                            <select data-toggle="tooltip" data-placement="left" title="District" class="form-control"  id="district" placeholder="District" name="district">
                ...
                <div id = "tabs-4">
                    <div class = "form-group">
                        <div class="col-sm-10">
                            ...
                            <label for = "use_gps"><?= t('Use GPS') ?></label>
                        </div>
                    </div><hr />
                    <?php
                    $row_use = isset($row_->use_gps) ? $row_->use_gps : "";
                    if ($row_use == '1') {
                        ?>
                        <div class = "form-group">
