        ...
        polygonOptions: {
			...
			sidediv.innerHTML = text;
                ...
                var image = {url: '<?= base_url("/assets/bs/css/images/map/bridge.png") ?>'};
                    ...
                    google.maps.event.addListener(marker_art, 'click', function(){infoWindow.setContent(this.title);
...
infoWindow.open(map,this);});
				...
				var marker_pub = new google.maps.Marker({
				 ...
				 google.maps.event.addListener(marker_pub, 'click', function(){infoWindow.setContent(this.title);
infoWindow.open(map,this);});
...
//-------------------
    ...
    <body >
		...
		<input id="myCheckboxwbridge" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/bridge.png") ?>" ><label>ស្ពានឈើ</label></td><br>
		<input id="myCheckboxbbridge" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/bridge_g.png") ?>" ><label>ស្ពានបេតុង</label></td><br>
		<input id="myCheckboxculvert" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/tires.png") ?>" ><label>លូមូលមុខមួយ</label></td><br>
		<input id="myCheckboxother" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/red.png") ?>" ><label>សំណង់សិល្បការ</label></td><br>
		<input id="myCheckboxschool" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/pub_building.png") ?>" ><label>សាលារៀន</label></td><br>
		<input id="myCheckboxmayor" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/administration.png") ?>" ><label>សាលាឃុំ</label></td><br>
		...
		<input id="myCheckboxpublic" type="checkbox" checked="checked" /> <input type="image" src="<?= base_url("/assets/bs/css/images/map/pub_building - Copy.png") ?>" ><label>សំណង់សាធារណៈ</label></td><br>
		</div>
