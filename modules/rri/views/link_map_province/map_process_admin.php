...
//province
$results2 = $mysqli->query("SELECT GROUP_CONCAT(lng, ',', lat, ',', '100' separator ' ') AS coordinates,tr.road_id FROM test_map as tr INNER JOIN  road_info AS rd ON rd.road_id = tr.road_id WHERE rd.pro_id = '02' group by Road_id ");
...
$descNode= $dom->createElement('description', 'Road Information <a href="http://localhost/rri/rri_db_2015-01-12/index.php/rri/roads/edit/'.encodeURIComponent(simple_encrypt($obj->road_id)).'">view the road</a>');
