...
<html>
    ...
    <body style="margin-top: 40px;">
        ...
        <div id="panel">
            ...
            <input id="myCheckboxother" type="checkbox" checked="checked" /><input type="image" src="<?= base_url("/assets/bs/css/images/map/red.png") ?>" ><label>សំណង់សិល្បការ</label><br>
            ...
            <input id="myCheckboxpublic" type="checkbox" checked="checked" /> <input type="image" src="<?= base_url("/assets/bs/css/images/map/pub_building - Copy.png") ?>" ><label>សំណង់សាធារណៈ</label><br>
        </div>
