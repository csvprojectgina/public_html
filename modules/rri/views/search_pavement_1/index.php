    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">        
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="example">
                <thead>
                    <tr>
                        <th style="text-align: center;"><?= t('ប្រ​ភេទ​​​កម្រាល') ?></th>
                        <th style="text-align: center;"><?= t('X ចាប់ផ្តើម') ?></th>
                        <th style="text-align: center;"><?= t('Y ចាប់ផ្តើម') ?></th>
                        <th style="text-align: center;"><?= t('X បញ្ចប់') ?></th>
                        <th style="text-align: center;"><?= t('Y បញ្ចប់') ?></th>
                        <th style="text-align: center;"><?= t('ប្រវែង​​កម្រាល') ?></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?= site_url('rri/Search_pavement/grid_pavement') ?>"
        });
