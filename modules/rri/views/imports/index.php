<form id="up_form" class="form-horizontal" role="form" action="<?= site_url('rri/imports/import_excel') ?>" method="post" enctype="multipart/form-data"> 
...
<script type="text/javascript">
    $(function() {
        ...
        $("#up_form").on('submit', (function(e) {
            $.ajax({
                url: "<?= site_url('rri/imports/import_excel') ?>",
                type: "post",
                datatype: "json",
