<form class="form-horizontal" role="form" action="<?= site_url('rri/imports/import_excel') ?>" method="post" enctype="multipart/form-data"> 
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><img src="<?= base_url('assets/bs/css/images/new.gif') ?>" /> <?= t('បញ្ចូលពី Excel') ?></h3>
        ...
        <div class="panel-body">
            ...
            <div class = "form-group">
                ...
                <div class="col-sm-10">
                    <select data-toggle="tooltip" data-placement="left" title="រាជធានី-ខេត្ត (ឧ.​ រាជធានីភ្នំពេញ...)" required class="form-control"  id="pro_id" placeholder="ប្រភេទផ្លូវ" name="pro_id">
                        <?php /* ?><?= getoption("SELECT * FROM province ORDER BY khmer_name", "id", "khmer_name", set_value('pro_id', isset($row->pro_id) ? $row->pro_id : ''), true) ?>
                          <?php */ ?>
            ...
            <div class = "form-group">
                ...
                <div class="col-sm-10">
                    <select data-toggle="tooltip" data-placement="left" title="រាជធានី-ខេត្ត (ឧ.​ រាជធានីភ្នំពេញ...)" class="form-control"  id="dis_id" placeholder="ប្រភេទផ្លូវ" name="dis_id">
                        <?php echo $dis_khmer; ?>
                        <?php /* ?><?= getoption("SELECT * FROM district ORDER BY dis_khmer", "id", "dis_khmer", set_value('dis_code', isset($row->dis_code) ? $row->dis_code : ''), true) ?><?php */ ?>
                    </select>                        
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input required type="file" class="form-control" placeholder="ជ្រើសរើសទីតាំងបញ្ចូល" name="excel_file[]" id="excel_file" multiple="multiple" accept="application/vnd.ms-excel" />
                </div>
            </div>
        </div>
