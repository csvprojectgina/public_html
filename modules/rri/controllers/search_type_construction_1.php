...
class Search_type_construction extends Admin_Controller {
    ...
    public function grid_type_construction() {
         ...
         */
        $aColumns = array('type_building', 'name_building', 'position_x', 'position_y', 'direction');
        $sIndexColumn = "road_id";

        /* DB table to use */
        $sTable = "public_building";
        ...
        if ($pr_code == "") {
            ...
            $sWhere .= "WHERE public_building.pro_id IN (" . $pr_code . ") ";
        }
        // ========================================
	...
	";
        ...
        if ($rResult->num_rows() > 0) {
            foreach ($rResult->result_array() as $aRow) {
                ...
                $row[] = '<a href="javascript:void(0)" class="editor_edit" style="text-align:center;">ខ្សែផ្លូវ</a>';
                $output['aaData'][] = $row;
            }
        }
